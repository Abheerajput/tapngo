...
//     <Row className="justify-content-center text-nowrap bg-white mt-4">
...
//                   <Form className="mt-5   text-dark" onSubmit={handleSubmit}>
//                     <div className='d-flex flex-column  responive-displayflex-md-row gap-3   md:w-100 ps-3 my-3 '>
//                       <Form.Group className="mb-3 w-100 w-sm-50 fs_16 red_ff fw-light  " controlId="firstName">
//                         <Form.Label>First Name</Form.Label>
//                         <Form.Control type="text" placeholder="First Name" />
//                       </Form.Group>
//                       <Form.Group className="mb-3 w-100 w-sm-50 fs_16 red_ff fw-light" controlId="lastName">
//                         <Form.Label>Last Name</Form.Label>
//                         <Form.Control type="text" placeholder="Last Name" />
//                       </Form.Group>
//                     </div>
//                     <div className='d-flex flex-column responive-display flex-md-row gap-3 w-100 my-3 ps-3'>
//                       <Form.Group className="mb-3 w-100 fs_16 red_ff fw-light " controlId="email">
//                         <Form.Label>Email Address</Form.Label>
//                         <Form.Control type="email" placeholder="example@gmail.com" />
//                       </Form.Group>
...
//                       </Form.Group>
//                     </div>
//                     <Form.Group className="mb-3 responive-display ps-3 w-100 fs_16 text-dark red_ff fw-light" controlId="accountType">
//                       <Form.Label>Account Type</Form.Label>
//                       <Form.Control type="text" placeholder="Prepaid" />
//                     </Form.Group>
//                     <div className='ps-3 w-100 text-dark'>
