      ...
      <Modal.Body className='text-center'>
        ...
        <Row>
          <Card className='mb-3 border-0 m-0'>
            <Card.Body className='d-flex justify-content-between align-items-center'>
              <div className='d-flex align-items-center'>
                <Image src={Apple_wallet} alt="Apple Wallet" className="me-3" />
          ...
          <Card className='mb-3 border-0 m-0'>
            <Card.Body className='d-flex justify-content-between align-items-center'>
              <div className='d-flex align-items-center'>
                <Image src={Samsung_wallet} alt="Samsung Wallet" className="me-3" />
          ...
          <Card className='mb-3 border-0 m-0'>
            <Card.Body className='d-flex justify-content-between align-items-center'>
              <div className='d-flex align-items-center'>
                <Image src={Google_wallet} alt="Google Wallet" className="me-3" />
